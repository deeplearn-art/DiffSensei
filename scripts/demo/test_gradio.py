...
class MangaPageApp:
    ...
    def create_ui(self, pipeline=None, tokenizer_mllm=None, agent_model=None):
    ...
    def launch(self, pipeline=None, tokenizer_mllm=None, agent_model=None):
...
def main():
    ...
    app = MangaPageApp()
    app.launch(pipeline, tokenizer_mllm, agent_model)
